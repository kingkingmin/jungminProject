	...
	function successcall(data) {
		...
		$.each(data, function(i) {
			...
			if (hh === $("#i2").val()) {
				...
				$('#mainTbl2').append(" ブロックされたのでメッセージを送ることができません。 ");
...
<br>
	<table class="friendtable2" >
				...
				<tr>
					<td rowspan="1" colspan="8"> <br><b>名前 : </b> ${friends.c_name }<br> <hr> </td>

				</tr>
				
				<tr>
				
					<td rowspan="1" colspan="8"><br><b>国  : </b> ${friends.c_countryJ }<br>  <hr></td>
				</tr>
				<tr>
				
					<td rowspan="1" colspan="8"><br><b>性別  : </b> ${friends.c_genderJ } <br> <hr><br></td>
				</tr>
				<tr>
					
					<td rowspan="1" colspan="2"> <b>日本語 : </b> ${lang[0]}</td>
					<td rowspan="1" colspan="2"><b>韓国語 :</b> ${lang[1]}</td>
					<td rowspan="1" colspan="2"><b>英語 :</b> ${lang[2]}</td>
					<td rowspan="1" colspan="2"><b>中国語 :</b> ${lang[3]} </td>
				...
				<button class="button4">前のページへ戻る</button>
				</form>
				...
				<button id="i4" class="button">メール送信</button>&nbsp;&nbsp;
				</form>
				...
				<button id="i5" class="button3">このユーザーブロックする </button>
				</form>
				...
				<button id="i10" class="button2">このユーザーブロック解除する </button>
				</form>
