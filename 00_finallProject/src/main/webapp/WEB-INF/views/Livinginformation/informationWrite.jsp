...
<body>
	...
	<form name="ex_form" action="inforwrite.go" method="post" enctype="Multipart/form-data" onsubmit="return checkinforwrite();">
		...
		<td colspan="5">  
		<button class="button"> 글 등록하기</button>
			...
			<tr>
				...
				<td colspan="4"><select name="f_sort" id="good" style="width:120px;height:35px;" >
						<option>선택</option>
				</select></td>
			</tr>
			...
			<tr>
				...
				<td colspan="4"><input name="f_title" required style="width:180px;height:35px;"></td>
		...
		<input name="f_mapinfo3" value="<div> 위치를 클릭하지 않았습니다. </div>"  type="hidden" > 
		<input id="input" name="f_mapinfoName" value="" placeholder="원하는 장소를 입력후 검색!" onfocus="this.placeholder=''" onblur="this.placeholder='원하는 장소를 입력후 검색!'" required style="width:180px;height:35px;"><br>
				</td>
