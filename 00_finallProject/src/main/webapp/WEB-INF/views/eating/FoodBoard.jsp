...
<body>
		...
		<tr>
			<td>
				<form action="showfoodboardSearch.go">
					...
					<input name="f_name" placeholder="레스토랑 이름으로 검색!"
						style="width: 200px; height: 35px; border-style: inset;" > &nbsp;&nbsp;
					<button class="button">검색</button>
					&nbsp;
					<button type="button" onclick="gobackfood()" class="button4">전체</button>
				</form>
			</td>
	...
	<table class="tableforsearch">
		...
		<tr>
			<td colspan="1"><a href="showfoodboardSearch.go?f_kind=돼지고기">
					#돼지고기</a></td>
			<td colspan="1"><a href="showfoodboardSearch.go?f_kind=소고기">#소고기</a>
			</td>
			<td colspan="1"><a href="showfoodboardSearch.go?f_kind=밀가루,국수">#국수,냉면</a>
			</td>
			<td colspan="1"><a href="showfoodboardSearch.go?f_kind=탕,국밥">#탕,국밥</a>
			</td>
			<td colspan="1"><a href="showfoodboardSearch.go?f_kind=게장">#게장</a>
			</td>
			<td colspan="1"><a href="showfoodboardSearch.go?f_kind=기타">#etc</a>
			</td>
		...
		<div align="center" id="inforL"  onclick="inforPageChange(${6});">
			...
			<c:forEach var="a" begin="1" end="${allPageCount}" step="1">
				<c:if test="${ a < 7  and curPage < 7}">
					<td>
						<div align="center" id="pagechangego"
							onclick="foodPageChange(${a});">
					...
					<c:if test="${ a > 5 }">
						<td>
							<div align="center" id="infor"
								onclick="foodPageChange(${allPageCount});">
