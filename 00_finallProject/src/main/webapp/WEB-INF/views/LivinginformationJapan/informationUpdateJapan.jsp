...
<body>
	...
	<form name="ex_form" action="inforUpdate.do" method="post" enctype="Multipart/form-data" onsubmit="return checkinforwrite();">
		...
		<td colspan="5">  
		<button class="button"> 文修正する</button>
		...
		<tr>
			...
			<tr>
				...
				<td colspan="4"><select id="selectcheck" name="f_category"
					onchange="categoryChange(this)" style="width:140px;height:35px;">
						...
						<option value="${inforboard.f_categoryK},${inforboard.f_categoryJ}">修正希望時選択</option>
			...
			<tr>
				...
				<td colspan="4"><select name="f_sort" id="good" style="width:220px;height:35px;" >
						<option value="${inforboard.f_sortK},${inforboard.f_sortJ}">選択</option>
				</select></td>
			</tr>
			...
			<tr>
				...
				<td colspan="4"><input name="f_title" value="${inforboard.f_title }" required style="width:210px;height:35px;"></td>
		...
		<input id="input" name="f_mapinfoName" value="${inforboard.f_mapinfoName}" placeholder="英語で検索してください。 ex ) Hapjeong Station
" onfocus="this.placeholder=''" onblur="this.placeholder='英語で検索してください。ex ) Hapjeong Station'" required style="width:310px;height:35px;"><br>
				</td>
	...
	<br> <hr>
		...
		<p>
			<em> 修正を希望する場合は地図をクリックしてください！ <br> 英語で検索してください。ex ) Hapjeong Station </em>
		</p>
