	...
	<tr>
		<td >
			<form action="findname.go">
					...
					이름 : <input name="search" style="width:150px;height:30px; border-style: inset;">
			&nbsp;
	...
	<tr>
		<td > <hr>
			<form action="findbyinfo.go">
					...
					<!-- 이름 검색: <input name="c_country"> -->
				 성별 : <select name="c_gender" style="width:100px;height:35px;">
				 ...
				 모국 : <select name="c_country" style="width:100px;height:35px;">
				...
				<button class="button">검색</button>&nbsp;&nbsp;
				<button class="button4" type="button" onclick="gobackfriend()">전체</button>
		...
		<a  href="findfriendmore.go?c_id=${m.c_id}"> 
			...
			<table class="friendtable" >
				...
				<tr>
					...
					<td rowspan="1" colspan="1">성별 :   ${m.c_genderK }   </td>
					<td rowspan="1" colspan="1">나라:   ${m.c_countryK }   </td>
