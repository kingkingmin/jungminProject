	...
	function successcall(data) {
		...
		$.each(data, function(i) {
			...
			if (hh === $("#i1").val()) {
				...
				$('#mainTbl2').append(" 차단당하셨습니다 답변은 불가능합니다  ");
...
<body>
		...
		<form action="writemail.go">
			...
			<table  class="tableforsearch">
				<tr>
					<td colspan="1">보낸사람 : ${k.c_sender }</td>
					<td colspan="1">보낸시간 : <fmt:formatDate value="${k.c_date }" type="both" dateStyle="short" timeStyle="short"/></td>
			...
			<br><br>
		<button id="i4" class="button2">답변하기</button>	&nbsp;&nbsp;  		
		<button type="button" onclick="delectmessage(${k.c_no})" class="button3">삭제</button>&nbsp; &nbsp; 
		<button type="button" onclick="gobackmessage()" class="button6">뒤로가기</button>
